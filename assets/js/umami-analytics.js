/* Anonymous, cookieless Umami tracking for Viking Fitness. */
(function () {
  "use strict";
  ...
  function installTracker(config) {
    var existingTracker = document.querySelector(
    ...
    tracker.defer = true;
    tracker.dataset.domains = "vikingfitness.es,www.vikingfitness.es";
  ...
  window.VikingUmamiAnalytics = { init: init };
  window.VikingUmamiAnalytics.ready = init();
})();
